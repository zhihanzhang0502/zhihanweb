...
This project studies when a hybrid e-commerce platform should introduce a consumer credit service, such as buy-now-pay-later, and whether the service should be shared with third-party sellers.
